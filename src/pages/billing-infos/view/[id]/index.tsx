...
import { getBillingInfoById } from 'apiSdk/billing-infos';
import { BillingInfoInterface } from 'interfaces/billing-info';

function BillingInfoViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('billing_info', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/billing-infos/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Biling Summary" text={data?.biling_summary} />
